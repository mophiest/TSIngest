...
echo "Next:"
echo "  ./scripts/deploy-online.sh --image '$TSINGEST_IMAGE'"
echo "The deploy script will create '$RECORDINGS_PATH' and set container write permissions when possible."
